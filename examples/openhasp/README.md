...
5. Die Entitäts-IDs `number.travellog_odometer_input` und `sensor.travellog_write_status` prüfen. Bei mehreren TravelLog-Instanzen im Speicher-Script zusätzlich `config_entry_id` setzen und die Entitäten derselben Instanz auswählen.
